	...
	public static void main(String[] args)
	{
		...
		while(s.hasNextInt())
		{
			...
			while(count-->0)
			{
				...
				if(resultint[1]!=0)
				{
					long gcdr=gcd(resultint[1],Long.valueOf(arr[1]));
					
					resultint[0]*=(Long.valueOf(arr[1])/gcdr);
					resultint[1]*=(Long.valueOf(arr[1])/gcdr);
					
					
					resultint[0]+=Long.valueOf(arr[0])*resultint[1]/Long.valueOf(arr[1]);
				...
				{
					resultint[0]=Long.valueOf(arr[0]);
					resultint[1]=Long.valueOf(arr[1]);
				}
				if(resultint[1]==0||resultint[0]==0)
				{
